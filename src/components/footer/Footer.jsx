...
export default function Footer() {
  ...
  const connectUs = [
    ...
    {
      item : 'Github',
      link : 'https://github.com/abhishekSonawane97',
      id : 1,
    },
    {
      item : 'Linkedin',
      link : 'https://www.linkedin.com/in/abhishek-sonawane-647148225/',
      id : 1,
    },
  ];
  ...
  return (
    ...
    <div className='w-full h-[max-content] pt-20 pb-12 flex gap-5 px-5 f_logo presents'>
      ...
      <div className="address mt-20 mb-5 flex flex-col justify-start items-start text-start w-1/2 mx-auto">
            <Link className='inline-block my-2' href="#"><span>Address : Kasturi Apt. Ulkanagari Maharashtra, INDIA.</span></Link>
            <Link className='inline-block my-2' href="#"><span>Mail : abhisheksonawane1997@gmail.com</span></Link>
            <Link className='inline-block my-2' href="#"><span>Phone : +91 8329914036</span></Link>
        </div>
    <div className="f_bot flex justify-between items-center bg-zinc-800 w-full text-zinc-400 px-auto">
        <Link href="#" className='block'>&copy; Abhishek Sonawane 2024 Legal Terms</Link>
        <p className='text-nowrap'>Website by Abhishek</p>
    </div>
    </div>
  )
}
