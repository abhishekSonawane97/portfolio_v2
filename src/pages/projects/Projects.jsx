...
export default function Projects() {
  ...
  const dropdownContent = [
    ...
    { 
      title : 'Coral Reef Andaman',
      content : 'Showcased the natural beauty and adventure of the Andaman Islands with vibrant visuals and interactive elements, ensuring a seamless experience across all devices.',
      link : 'https://www.coralreefandaman.com/',
      id : 6,
    },
    { 
